...
export const REAL_ESTATE_STATUSES = [
  ...
  { value: 'site_visit_scheduled', label: 'Site Visit Scheduled', color: '#F59E0B', category: 'interested' },
  { value: 'site_visit_done', label: 'Site Visit Done', color: '#6366F1', category: 'interested' },
